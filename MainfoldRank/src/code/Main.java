...
public class Main {
	...
	public static void main(String args[])throws Exception{
		...
		String language = "1", type = "1", abNum = "60", stopwordPath = "n", stemmerOrNot = "2";
		String topic = "-1", ReMethod = "1", RePara = "0.7", beta = "-1", alpha = "0.85", eps = "0.00001";
		String linkThresh = "0.1", AlphaC = "0.1", LambdaC = "0.8", op = "2", AlphaS = "0.5", LambdaS = "-1";
		String[] arg;
		
		String file = "D:\\eclipse-jee-luna-SR1-win32-x86_64\\eclipse\\workspaces\\LexPageRank\\data\\article";
		String outFile = "D:\\eclipse-jee-luna-SR1-win32-x86_64\\eclipse\\workspaces\\LexPageRank\\data\\articleResult";
		...
		for(File fOrd : files) {
			...
			arg[1] = outFile + System.getProperty("file.separator") + fOrd.getName() + ".txt";
			arg[2] = language;
			arg[3] = "3";
			arg[4] = abNum;
			arg[5] = ReMethod;
			...
			arg[8] = alpha;
			arg[9] = eps;
			arg[10] = "E:\\DATA\\SUNNY_ManifordRankData&Result\\TOPIC" + System.getProperty("file.separator") + fOrd.getName() + ".txt";
